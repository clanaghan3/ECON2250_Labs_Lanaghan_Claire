...
3.  Install git on you computer. And check if it shows up in Rstudio, if not go to **Tools** $\rightarrow$ **Version Control** and select **Git**.g22
...
```{r, echo=T, eval=T}
#| label: auctions
#| data("babynames", package = "probstats4econ")
# Create data
data1 <- babynames  %>%
  slice_head(n = 10
# plot
ggplot(data1, aes(x=name, y=count)) +
